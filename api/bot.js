...
bot.start(async (ctx) => {
    ...
    if (!userDoc) {
        ...
        let adminNotific// --- LOAD LIBRARIES ---
require('dotenv').config();
const { Telegraf, Markup, Scenes, session } = require('telegraf');
const { MongoClient } = require('mongodb');
const axios = require('axios');
...
// Step 1 of the Add Credit Wizard
...
// Step 2 of the Add Credit Wizard
...
// Step 3 of the Add Credit Wizard
...
// Create the Add Credit Wizard Scene
